...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'URLHistory.time_added'
        db.alter_column('main_urlhistory', 'time_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'URLHistory.time_added'
        db.alter_column('main_urlhistory', 'time_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
