...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppRegistration'
        db.create_table('main_appregistration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Application'])),
        ))
        db.send_create_signal('main', ['AppRegistration'])


    def backwards(self, orm):
        # Deleting model 'AppRegistration'
        db.delete_table('main_appregistration')
