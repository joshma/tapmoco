...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_application', (
            ...
            ('reg_url', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('check_reg_url', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('update_url', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
        ))
        db.send_create_signal('main', ['Application'])

        # Deleting field 'UserProfile.url'
        db.delete_column('main_userprofile', 'url')

        # Deleting field 'UserProfile.secret'
        db.delete_column('main_userprofile', 'secret')
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_userprofile', 'url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.secret'
        db.add_column('main_userprofile', 'secret',
