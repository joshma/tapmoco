...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_userprofile', (
            ...
            ('at_desk', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('main', ['UserProfile'])

        # Adding model 'URLHistory'
        db.create_table('main_urlhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
        ))
        db.send_create_signal('main', ['URLHistory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'URLHistory'
        db.delete_table('main_urlhistory')
